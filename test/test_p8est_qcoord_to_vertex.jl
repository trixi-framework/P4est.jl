function iter_volume_for_p8est_qcoord_to_vertex(info::Ptr{p8est_iter_volume_info_t},
                                                user_data)
    ...
    p8est_qcoord_to_vertex(p4est_obj.connectivity,
                           info_obj.treeid,
                           quad_obj.x,
                           quad_obj.y,
                           quad_obj.z,
...
@testset "p8est_qcoord_to_vertex" begin
    iter_volume_c = @cfunction(iter_volume_for_p8est_qcoord_to_vertex,
                               Cvoid,
